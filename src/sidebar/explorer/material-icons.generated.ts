...
// Produced by scripts/generate-material-icons.mjs from material-icon-theme@5.37.0
 ...
 *  → Material Icon Theme icon id. 1378 entries. */
export const MATERIAL_EXT_TO_ICON: Readonly<Record<string, string>> = {
  "60": "slint",
 ...
 *  MATERIAL_EXT_TO_ICON when a name matches. 2131 entries. */
export const MATERIAL_FILENAME_TO_ICON: Readonly<Record<string, string>> = {
  ".rhistory": "r",
  "._sc_": "godot-assets",
 ...
 *  generic-file glyph). */
export const MATERIAL_DEFAULT_ICON = "file";
